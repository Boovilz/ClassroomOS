...
import { Bar, BarChart, CartesianGrid, XAxis, YAxis, PolarGrid, PolarAngleAxis, Radar, RadarChart } from "recharts";
...
export function AcademicAnalyticsChart({ data }: { data: AcademicAnalyticsPoint[] }) {
