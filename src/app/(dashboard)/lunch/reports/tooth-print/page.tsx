...
export default async function ToothBrushPrintPage({
  searchParams,
}: {
  ...
  const months = await buildDailyRecordMonths(ctx.schoolId, grade, classroom, beYear, "tooth_brush");

  return (
    <MonthlyTrackingPrint
      reportType="tooth_brush"
      grade={grade}
      classroom={classroom}
